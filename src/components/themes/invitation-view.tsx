          ...
          <div className="relative z-10 anim-fade-up">
            ...
            {coupleTitle ? (
              data.coverNameType === "initial" ? (
                <div className="relative mx-auto mt-12 h-72 w-full max-w-sm leading-none sm:h-96">
                  ...
                  <span className={`${hf("pembuka")} absolute left-1/2 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2 text-6xl md:text-7xl`} style={{ color: p.accent }}>&amp;</span>
            ...
            {firstEventDate && (
              <p className="mt-12 text-sm tracking-[0.25em]" style={{ color: p.textMuted }}>
            ...
            <button
              onClick={handleOpen}
              className="anim-ring mt-12 inline-flex items-center gap-2 rounded-full px-8 py-3.5 text-sm font-bold shadow-xl transition hover:scale-[1.03] active:scale-95"
